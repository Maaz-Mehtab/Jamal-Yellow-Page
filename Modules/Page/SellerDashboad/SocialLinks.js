                        ...
                        <View style={styles.MainContainer}>
                            ...
                            <View style={{ width: '100%', height: screenheight - 80, backgroundColor: '#f4f4f4' }}>
                                ...
                                <View style={{ width: '96%', height: 'auto', margin: '2%' }}>
                                    ...
                                    <View style={{ width: '100%', height: 45,  marginTop: 10 ,justifyContent:'center',alignItems:'center'}}>
                                        <View style={{ width: '98%', flexDirection: 'row', marginTop: 2, backgroundColor: '#e0e0e0', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                            <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                                <Icon style={{ color: 'black', fontSize: 25 }} name={'social-facebook'} />
                                            </View>
                                    ...
                                    <View style={{ width: '100%', height: 45,  marginTop: 10 ,justifyContent:'center',alignItems:'center'}}>
                                        <View style={{ width: '98%', flexDirection: 'row', marginTop: 2, backgroundColor: '#e0e0e0', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                            <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                                <Icon style={{ color: 'black', fontSize: 25 }} name={'social-youtube'} />
                                            </View>
                                            <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                                <TextInput
                                                    style={{ height: 40, width: '100%', }}
                                    ...
                                    <View style={{ width: '100%', height: 45,  marginTop: 10 ,justifyContent:'center',alignItems:'center'}}>
                                        <View style={{ width: '98%', flexDirection: 'row', marginTop: 2, backgroundColor: '#e0e0e0', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                            <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                                <Icon style={{ color: 'black', fontSize: 25 }} name={'social-twitter'} />
                                            </View>
                                            <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                                <TextInput
                                                    style={{ height: 40, width: '100%', }}
                                 ...
                                 <View style={{ width: '100%', height: 45,  marginTop: 10 ,justifyContent:'center',alignItems:'center'}}>
                                        <View style={{ width: '98%', flexDirection: 'row', marginTop: 2, backgroundColor: '#e0e0e0', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                            <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                                <Icon style={{ color: 'black', fontSize: 25 }} name={'social-linkedin'} />
                                            </View>
                                            <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                                <TextInput
                                                    style={{ height: 40, width: '100%', }}
                                    ...
                                    <View style={{ width: '100%', height: 45,  marginTop: 10 ,justifyContent:'center',alignItems:'center'}}>
                                        <View style={{ width: '98%', flexDirection: 'row', marginTop: 2, backgroundColor: '#e0e0e0', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                            <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                                <Icon style={{ color: 'black', fontSize: 25 }} name={'social-instagram'} />
                                            </View>
                                            <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                                <TextInput
                                                    style={{ height: 40, width: '100%', }}
                                    ...
                                    <View style={{justifyContent:'center',alignItems:'center',width:'100%',height:50,marginTop:10}}>
                                        <TouchableOpacity style={[styles.ThemeColorYellow,{borderRadius:5,width:'50%',height:35,justifyContent:'center',alignItems:'center',borderStyle:'solid',borderWidth:2,borderColor:'black'}]}>
