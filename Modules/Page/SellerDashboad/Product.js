                ...
                <View style={styles.ParentContainer}>
                    ...
                    <ScrollView style={styles.ScrollContainer}>
                        <View style={styles.MainContainer}>
                            ...
                            <View style={{ width: '100%', height: screenheight-80, backgroundColor: '#f4f4f4' }}>
                                ...
                                <View style={{ width: '96%', height: 'auto',  margin: '2%' }}>
                                    <View style={{ width: '100%', height: 50, backgroundColor: 'black', justifyContent: 'center', alignItems: 'center', flexDirection: 'row',borderBottomColor:'white',borderStyle:'solid',borderBottomWidth:1,borderLeftWidth:1,borderLeftColor:'black' }}>
                                        <View style={{ width: '15%', height: 50, alignItems: 'center', justifyContent: 'center',borderRightColor:'white',borderStyle:'solid',borderRightWidth:1 ,}}>
                                        ...
                                        <View style={{ width: '50%', height: 50, alignItems: 'center', justifyContent: 'center',borderRightColor:'white',borderStyle:'solid',borderRightWidth:1 }}>
                                            <Text style={{ textAlign: 'center', fontWeight: 'bold',color:'white' }}>
                                                Name
                                            </Text>
                                        </View>
                                        <View style={{ width: '35%', height: 50, alignItems: 'center', justifyContent: 'center',borderRightColor:'black',borderStyle:'solid',borderRightWidth:1 }}>
                                            <Text style={{ textAlign: 'center', fontWeight: 'bold',color:'white' }}>
                                                Status
                                            </Text>
                                        </View>
                                    ...
                                    (this.state.data.map((val,ind)=>{
                                        return(
                                            <TouchableOpacity key={ind} style={{ width: '100%', height: 'auto',  justifyContent: 'center', alignItems: 'center', flexDirection: 'row',borderBottomColor:'black',borderStyle:'solid',borderBottomWidth:1,borderLeftColor:'black',borderLeftWidth:1 }}>
                                            <View style={{ width: '15%', height: 50, alignItems: 'center', justifyContent: 'center',borderRightColor:'black',borderStyle:'solid',borderRightWidth:1 }}>
                                            <Text style={{ textAlign: 'center', fontWeight: 'bold' ,color:'black'}}>
                                                {val.id}
                                            </Text>
                                        </View>

                                         <View style={{ width: '50%', height: 50, alignItems: 'center', justifyContent: 'center',borderRightColor:'black',borderStyle:'solid',borderRightWidth:1 }}>
                                            <Text style={{ textAlign: 'center', fontWeight: 'bold',color:'black' }}>
                                               {val.name}
                                            </Text>
                                        </View>
