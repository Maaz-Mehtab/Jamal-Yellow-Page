...
export default class ListingRequest extends Component {
    constructor(props) {
        super(props);
        this.state = {
            modalVisible: false,
    ...
    next() {
        ...
        else if(this.state.uan==""){
            ToastAndroid.show("Enter UAN Number ", ToastAndroid.LONG)
        }
        else if(this.state.web==""){
            ToastAndroid.show("Enter Web Address ", ToastAndroid.LONG)
        }
        else if(this.state.business==""){
            ToastAndroid.show("Enter Business Detail ", ToastAndroid.LONG)
        }
        else {
        this.setState({
            next: true
                    ...
                    <ScrollView style={styles.ScrollContainer}>
                        <View style={styles.MainContainer}>
                            ...
                            {this.state.next == false &&
                                ...
                                <View style={{ width: '96%', margin: '2%', height: 555, backgroundColor: '#e0e0e0' }}>

                                    <View style={[styles.ThemeColorBlack,{ width: '98%', height: 40, marginTop: 10, margin: 5, borderRadius: 5, justifyContent: 'center' }]}>
                                        <Text style={{ textAlign: 'center', color: 'white', fontSize: 18 }}>Company Detail</Text>
                                    </View>
                                    ...
                                    <View style={{ width: '98%', height: 40, flexDirection: 'row', marginTop: 10, backgroundColor: 'white', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                        <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                            <Iconsssss style={{ color: 'black', fontSize: 25 }} name={'business-center'} />
                                        </View>
                                        <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                            <TextInput
                                                style={{ height: 40, width: '100%', }}
                                ...
                                <View style={{width:'100%',height:40,justifyContent:'center',alignItems:'center'}}>
                                    ...
                                    <TouchableOpacity onPress={this.next} style={[styles.ThemeColorYellow,{ width: '60%', height: 40, borderColor: 'black', borderStyle: 'solid', borderWidth: 2, marginTop: 10, margin: 5, borderRadius: 5, justifyContent: 'center',alignItems:'center' }]}>
                            ...
                            {this.state.next == true &&
                                ...
                                <View style={{ width: '96%', margin: '2%', height: 540, backgroundColor: '#e0e0e0' }}>

                                    <View style={[styles.ThemeColorBlack,{ width: '98%', height: 40, marginTop: 10, margin: 5, borderRadius: 5, justifyContent: 'center' }]}>
                                        <Text style={{ textAlign: 'center', color: 'white', fontSize: 18 }}>Personal Detail</Text>
                                    </View>
                                    ...
                                    <View style={{ width: '98%', height: 40, flexDirection: 'row', marginTop: 10, backgroundColor: 'white', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                        <View style={{ width: '15%', alignItems: 'center', justifyContent: 'center', }}>
                                            <Iconsssss style={{ color: 'black', fontSize: 25 }} name={'description'} />
                                        </View>
                                        <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                            <TextInput
                                                style={{ height: 40, width: '100%', }}
                                    ...
                                    <View style={{ width: '98%', height: 40, flexDirection: 'row', marginTop: 10, backgroundColor: 'white', margin: 5, borderRadius: 5, justifyContent: 'center' }}>
                                        ...
                                        <View style={{ width: '82%', height: 'auto', alignItems: 'center', justifyContent: 'center' }}>
                                            <TextInput
                                                style={{ height: 40, width: '100%', }}
                                                onChangeText={(text) => { this.setState({ pphone: text, }) }}
                                                keyboardType='numeric'
                                                placeholder="Phone No"
                                                placeholderTextColor="#9e9e9e"
                                    ...
                                    <View style={{ width: '98%', height: 20, flexDirection: 'row', marginTop: 10, margin: 5, borderRadius: 5, justifyContent: 'center' }}>

                                        <Text style={{ textAlign: 'center', fontWeight: 'bold', color: 'black', fontSize: 14 }}>
                                            Please check the appropriate option below :
                                       </Text>
                                    </View>

                                    <View style={{ width: '90%', height: 35, flexDirection: 'row', alignItems: 'center', }}>
                                        <CheckBox
                                            value={this.state.checked1}
                                            onValueChange={() => this.setState({ checked1: !this.state.checked1 })}
                                        />
                                        <Text style={{ marginTop: 0, fontSize: 12 }}> Yes, I am interested in advertising in JYP </Text>
                                    </View>
                                    ...
                                    <View style={{ width: '90%', height: 35, flexDirection: 'row', alignItems: 'center', }}>
                                        ...
                                        />
                                        <Text style={{ marginTop: 0, fontSize: 12 }}> Yes, I am interested in advertising in JYP B2B CD ROM VERSION  </Text>
                                    </View>
                                    ...
                                    <View style={{ width: '90%', height: 35, flexDirection: 'row', alignItems: 'center', }}>
                                        ...
                                        />
                                        <Text style={{ fontSize: 12, marginTop: 0 }}> Yes, I am interested in advertising at jamals.com  </Text>
                                    </View>
                                    ...
                                    <View style={{ width: '90%', height: 35, flexDirection: 'row', alignItems: 'center', }}>
                                        ...
                                        />
                                        <Text style={{ fontSize: 12, marginTop: 0 }}> No, Just put my company details in your web listing </Text>
                                    </View>


                                    <View style={{ width: '100%', height: 'auto', marginTop: 10, alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>

                                        <TouchableOpacity onPress={this.back} style={[styles.ThemeColorBlack,{ width: '46%', height: 40, borderColor: '#ffff00', borderStyle: 'solid', borderWidth: 2, marginTop: 10,  margin: 5, borderRadius: 5, justifyContent: 'center' }]}>
