                            ...
                            this.setState({ ResponseData: Response.Data },
                                () => {
                                    if (this.state.ResponseData != undefined && Response.Data.message == undefined) {
                                        console.log("this.state.ResponseData.records.length ",this.state.ResponseData.records.length )
                    ...
                    <LinearGradient colors={['#FEDF7C', '#FEDF7C', '#FEDF7C']} style={{ width: '100%', height: 90 }}>
                        <View style={{ width: '100%', alignItems: 'center', height: 40, flexDirection: 'row', top: 2 }}>
                            <View style={{ margin: 5, width: '69%', height: 40, }}>
                                <TextInput
                                    // autoFocus={true}
                                    style={{ height: 40, borderColor: '#9e9e9e', borderWidth: 1, width: '100%', textAlign: 'center', backgroundColor: '#eeeeee' }}
                            ...
                            <TouchableOpacity onPress={() => { this.props.navigation.navigate('Home'); this.setState({ flag: false, picked: '' }) }} style={{ backgroundColor: 'transparent', width: '25%', height: 40, margin: 5, borderRadius: 10, justifyContent: 'center' }}>
